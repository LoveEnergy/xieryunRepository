...
class CourseListViewModel: NSObject, BaseListViewModel {
    var page: Int = 1
    ...
    func loadData() {
        self.page = 1
        RequestHelper.shared.getCoursesProductList(id: self.parentID, type: "1", classType: "", seriesID: self.seriesID, pageNo: self.page.string, pageSize: self.pageSize.string)
            .asObservable()
