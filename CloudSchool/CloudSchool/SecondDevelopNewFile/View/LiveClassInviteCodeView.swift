...
class LiveClassInviteCodeView: UIView {
    public var liveClassInviteCodeViewDismissBlock:(()->())?//消失
    ...
    override init(frame: CGRect) {
        ...
        let sureBtnH = 45/WIDTH_6_SCALE
        let sureBtnW = 110/WIDTH_6_SCALE
        self.sureBtn.frame = CGRect(x: self.whiteBGView.width - 15/WIDTH_6_SCALE - sureBtnW, y: (self.whiteBGView.height - self.topImgView.height - sureBtnH)/2 + self.topImgView.height, width: sureBtnW, height: sureBtnH)
...
extension LiveClassInviteCodeView{
    ...
    func dismissView(){
        self.liveClassInviteCodeViewDismissBlock?()
    }
