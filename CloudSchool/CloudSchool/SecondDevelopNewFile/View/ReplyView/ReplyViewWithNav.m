...
@interface ReplyViewWithNav()<UITextFieldDelegate>
//@property (nonatomic,strong) UITextField *commentTextField;//评论输入框
@property (nonatomic, strong)UIButton *sendBtn;
@property (nonatomic, strong)UIView * shadowView;
@end

@implementation ReplyViewWithNav
...
- (void)keyboardWasShown:(NSNotification*)aNotification{
    ...
    [UIView animateWithDuration:duration animations:^{
        self.frame = CGRectMake(0, SCREEN_HEIGHT - 51/WIDTH_6_SCALE - keyBoardFrame.size.height - NAVI_HEIGHT, SCREEN_WIDTH, 51/WIDTH_6_SCALE);
    }];
}
/**
 监听键盘消失
...
- (void)keyboardWillBeHidden:(NSNotification*)aNotification{
    CGFloat duration = [[[aNotification userInfo] objectForKey:UIKeyboardAnimationDurationUserInfoKey] floatValue];
    [UIView animateWithDuration:duration animations:^{
        self.frame = CGRectMake(0, SCREEN_HEIGHT - BOTTOM_HEIGHT - 51/WIDTH_6_SCALE - NAVI_HEIGHT, SCREEN_WIDTH, 51/WIDTH_6_SCALE);
    }];
